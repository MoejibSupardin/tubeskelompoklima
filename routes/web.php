...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::resource('wisataAdmin', WisataController::class);
});
...
route::get('wisataUser', [HomeController::class, 'wisataUser']);
route::get('wisataUser-detail/{id}', [HomeController::class, 'wisataUserDetail']);
